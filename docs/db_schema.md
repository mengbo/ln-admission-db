...
> 实际表清单以 `sqlite3 data.sqlite3 ".tables"` 为准；下表为最近一次 build 的快照。

| 表系列 | 已覆盖年份 |
|---|---|
| `plan_YYYY` | 2022, 2023, 2024, 2025, 2026 |
| `score_phyYYYY` | 2022, 2023, 2024, 2025, 2026 |
| `score_hisYYYY` | 2023, 2024, 2025, 2026（**注意：2022 历史上未发布**） |
| `rank_phyYYYY` | 2022, 2023, 2024, 2025, 2026 |
| `rank_hisYYYY` | 2022, 2023, 2024, 2025, 2026 |
...
一共可填 100+ 个志愿。详细说明见 [AGENTS.md 辽宁志愿模式](../AGENTS.md#-辽宁志愿模式核心概念)。
...
冲稳保筛选时，AI 输出的"志愿"颗粒度 = 1 行 = 1 个槽；
最终志愿表（第 4 节）按 (院校, 专业) 全局去重即可。
...
| `plan_num` | INTEGER | 该院校此专业在辽宁计划招生人数 |
